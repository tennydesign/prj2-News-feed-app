...
open class SOContainerViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    private static let kSideMenuDefaultWidth: CGFloat = 230//260.0
    ...
    internal let SideViewControllerOpenAnimationDuration: TimeInterval = 0.5 //0.24
...
extension SOContainerViewController {
    ...
    @IBAction internal func contentCoverViewClicked() {
        if self.isSideViewControllerPresented {
            ...
            //Triggers a reload from News tableViewController
            NotificationCenter.default.post(name: NSNotification.Name(rawValue: "load"), object: nil)
            NotificationCenter.default.post(name: NSNotification.Name(rawValue: "fadeOutControls"), object: nil)
    ...
    @IBAction internal func moveMenu(_ panGesture: UIPanGestureRecognizer) {
        ...
        // fades the controls in
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "fadeInControls"), object: nil)
